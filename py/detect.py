...
class Detect(object):
    ...
    def sendAttack(self, loopTimes: int,) -> None:
        ...
        if len(self.enemy_x_list) >= 2 and loopTimes % 2 == 0 and not self.chapter:
    ...
    def sendStones(self, loopTimes: int) -> None:
        ...
        '''
        if loopTimes == 20 and not self.chapter:
    ...
    def sendMedicines(self,loopTimes:int) -> None:
        ...
        if self.player1_life < 50 and self.medicineAmount > 0 and loopTimes == 20 and not self.chapter:
