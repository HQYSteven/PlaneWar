...
class init(programme):
    ...
    def init_modules(master,):
        ...
        '''
        master.settingIconPath = pygame.image.load(
            tools.file.sourceConfig("settingIconPath"),)
        master.backIconPath = pygame.image.load(
            tools.file.sourceConfig("backIconPath"),)
        master.singleIconPath = pygame.image.load(
            tools.file.sourceConfig("singleIconPath"),)
        master.doubleIconPath = pygame.image.load(
            tools.file.sourceConfig("doubleIconPath"),)
        master.aboutIconPath = pygame.image.load(
            tools.file.sourceConfig("aboutIconPath"),)
        master.music = True
